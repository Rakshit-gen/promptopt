          ...
          <div className="container-content relative grid w-full gap-12 py-16 lg:grid-cols-[1.05fr_1fr] lg:items-center">
            <div className="min-w-0">
              ...
              <div className="mt-7 flex flex-col gap-3 sm:flex-row">
                <a
                  href="#install"
                  className="shimmer inline-flex items-center justify-center rounded-md border border-accent/40 bg-accent/10 px-4 py-2.5 text-sm font-medium text-fg transition-colors hover:bg-accent/15"
                >
                  Install CLI
                </a>
                <Link
