...
void main() {
  ...
  vec3 amberDim = vec3(0.788, 0.510, 0.059);

  vec3 col = base;
  col += (amberDim - base) * smoothstep(0.30, 1.05, f) * 0.45;
  col += (amber - base) * smoothstep(0.55, 1.1, r.y) * 0.24;
  col += amber * pow(max(0.0, r.x - 0.45), 2.0) * 0.24;

  // subtle scanline shimmer
  col += amber * 0.015 * sin(uv.y * u_res.y * 0.6 + u_time * 2.0);
